    ...
    <div className="min-h-screen p-8 max-w-4xl mx-auto">
      ...
      <div className="mb-8">
        ...
        <p className="text-gray-400">
          Type a vague prompt. An agent chain interprets your intent, generates a
          playable HTML5 canvas game, and evals score it automatically.
        </p>
      </div>
            ...
            >
              ...
              {gen.status === "done" && gen.summaryScore !== undefined && (
                <div className="mt-2 flex gap-4 text-xs">
                  <span className={gen.runtimePass ? "text-green-400" : "text-red-400"}>
                    Runtime: {gen.runtimePass ? "PASS" : "FAIL"}
                  </span>
                  <span className={gen.interactionPass ? "text-green-400" : "text-red-400"}>
